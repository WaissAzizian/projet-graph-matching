...
quick_experiment:
	python3 train/train.py --num_examples_train 10 --num_examples_test 10 --print_freq 100 --epoch 1 --mode experiment --lr 0.0001 --num_layers 3 --num_blocks 2 --num_features 16 --sinkhorn_iterations 5
