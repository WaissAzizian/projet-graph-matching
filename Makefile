...
classification_experiment:
	python3 train/train.py --num_examples_train 800 --num_examples_test 200 --classification --epoch 10 --num_features 2 --num blocks 3 --num_layers 10 --lr 0.01
	python3 train/train.py --num_examples_train 800 --num_examples_test 200 --classification --epoch 10 --num_features 2 --num blocks 3 --num_layers 10 --lr 0.005
	python3 train/train.py --num_examples_train 800 --num_examples_test 200 --classification --epoch 10 --num_features 2 --num blocks 3 --num_layers 10 --lr 0.001
