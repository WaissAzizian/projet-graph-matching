...
experiment:
	python3 train/train.py --num_examples_train 1750 --num_examples_val 499 --num_examples_test 1 --print_freq 100 --epoch 50 --mode experiment --lr 0.001 --num_layers 3 --num_blocks 2 --num_features 32 --real_world_dataset --generative_model Letter-high --gamma 0.9
